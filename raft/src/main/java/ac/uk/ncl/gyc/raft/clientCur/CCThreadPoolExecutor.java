...
public class CCThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CCThreadPoolExecutor.class);
    ...
    public CCThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit,
                                BlockingQueue<Runnable> workQueue, CCThreadPool.NameThreadFactory nameThreadFactory) {
